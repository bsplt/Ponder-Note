...
- `FIGMA-DEVIATIONS.md` - records Figma review gaps and intended checks
...
- **Impact:** Visual diff and alignment could not be verified; documented in `FIGMA-DEVIATIONS.md` for follow-up.
